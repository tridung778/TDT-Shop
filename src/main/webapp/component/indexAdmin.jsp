	...
	<div class="wrapper">
		<aside id="sidebar">
			...
			<ul class="sidebar-nav">
				<li class="sidebar-item"><a href="indexAdmin" class="sidebar-link text-decoration-none"> <i class="lni lni-user"></i> <span>Profile</span>
				</a></li>
				<li class="sidebar-item"><a href="addProduct" class="sidebar-link text-decoration-none"> <i class="lni lni-agenda"></i> <span>Task</span>
				</a></li>
